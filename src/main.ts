...
* 0. DO THIS NEXT: 
   ...
   - To do this really right, would need to preserve paragraph structure which is probably much more difficult as I currently don't detect paragraphs just sentences.
